...
2. LEVEL 1 — Run automated scan:
   $PYTHON ~/.qwen/skills/aif-skill-generator/scripts/security-scan.py <skill-path>
3. Check exit code:
...
2. **LEVEL 1** — Run automated scanner:
   ```bash
   $PYTHON ~/.qwen/skills/aif-skill-generator/scripts/security-scan.py <path>
   ```
...
$PYTHON ~/.qwen/skills/aif-skill-generator/scripts/security-scan.py <installed-path>
```
...
```bash
$PYTHON ~/.qwen/skills/aif-skill-generator/scripts/security-scan.py ./skill-name/
```
...
```bash
python ~/.qwen/skills/dependency-graph/scripts/visualize.py $ARGUMENTS
```
```
...
1. **Local**: Keep in `~/.qwen/skills/` for personal use
2. **Project**: Add to `.qwen/skills/` and commit
